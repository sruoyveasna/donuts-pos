{{-- resources/views/categories/partials/edit-modal.blade.php --}}
@if($canWrite)
@php $locale = app()->getLocale(); @endphp

<dialog id="editModal" class="m-0 bg-transparent">
  <div
    ...
    <div
      ...
      <div class="min-w-0">
        <div class="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-wide">
          ...
          <span class="truncate">
            {{ __('messages.categories_edit_title', [], $locale) ?: 'Edit category' }}
          </span>
        </div>
        <p class="mt-0.5 text-[11px] text-slate-200/80 truncate">
          {{ __('messages.categories_edit_subtitle', [], $locale) ?: 'Rename or hide this category from your POS.' }}
        </p>
      </div>
      ...
      <form id="editForm" class="px-4 md:px-5 py-4 space-y-4">
        ...
        <div
          ...
          <div class="min-w-0">
            ...
            <p class="text-[11px] text-slate-500 dark:text-slate-400">
              {{ __('messages.categories_field_active_hint', [], $locale) ?: 'Turn off to temporarily hide this category from the POS.' }}
            </p>
          </div>
        ...
        <div class="flex justify-between items-center pt-1">
          ...
          <button type="submit"
            ...
            <span>{{ __('messages.categories_button_save_changes', [], $locale) ?: 'Save changes' }}</span>
          </button>
        </div>
      </form>
    </div>
